...
{
    [HttpPost]
    [Authorize(Policy = Permissions.Billings.Create)]
    ...
    [HttpGet]
    [Authorize(Policy = Permissions.Billings.Read)]
    ...
    [HttpGet]
    [Authorize(Policy = Permissions.Billings.ReadById)]
    [Route("{id}")]
    ...
    [HttpPut]
    [Authorize(Policy = Permissions.Billings.Update)]
    [Route("{id}")]
    ...
    [HttpDelete]
    [Authorize(Policy = Permissions.Billings.Delete)]
    [Route("{id}")]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(typeof(ResponseErrorJson), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(ResponseErrorJson), StatusCodes.Status400BadRequest)]
